...
\DRULEPF{Negating an Equivalence\label{drule:neg_equiv}}{
If $\pA\DARR\pB$, then $\neg\pA\DARR\neg\pB$.
}{
...
Then negate this equivalence (see derived rule \ref{drule:neg_equiv}) to obtain the desired equivalence.
}{
