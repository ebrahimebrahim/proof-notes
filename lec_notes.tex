...
\newcommand{\RULE}[2]{\begin{adjustwidth}{2em}{}#1: #2\end{adjustwidth}}
\newcommand{\THM}[2]{\textbf{Theorem:} #1\\\textit{Proof:} #2\done}
...
To prove $\neg\pA$ is to disprove $\pA$, and in fact this is simply what is meant by ``disprove.''
...
Let's do an example using English sentences.
% pf by contradiction
% give written formatting of it
% give english example
...
\subsubsection{Implication and Double Implication}
