...
Which propositions are true? What does ``true'' even mean?
...
which makes then serve as starting points in our mathematical system.
...
For an example, look at the end of this section for an informal version of the five-line proof above.
...
But now it's much easier to process the arguments, though I'm not expecting you to do so just yet.


\ex{
\note{
lang with the following propositions: three by three grid with some squares containing a dot and some not.
the following 2 logical rules: can rot by 90 degrees clockwise. can glom two props together which is like adding vectors in Z2.
the following 2 axioms: top mid dot; right mid dot and bottom left dot

questions:
1 how many props in this language? how many props in math?
2 completely formally and rigorously prove that
- -
---
3 (open ended) can you think of a way to write an informal proof?
something that captures the idea of your proof, 
but communicates it more efficiently in English and doesn't show every step in detail.
basically your informal proof is a description of the formal proof, or *instructions* for how to write the formal proof.
4 (extra for fun and not relevant to main point) can you figure out how many propositions in this language are provable and how many are not?
}
}
