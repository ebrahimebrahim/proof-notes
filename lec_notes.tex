...
\newcommand{\THMMOCK}[2]{\textbf{Theorem:} #1\\[0.5em]\textit{Proof:} #2\qed}
\newcommand{\THM}[2]{\textbf{Theorem \putThmNumber:} #1\\[0.5em]\textit{Proof:} #2\qed}
\newcommand{\AXIOM}[1]{\textbf{Axiom \putThmNumber:} #1}
