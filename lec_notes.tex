...
\ex{Prove that $x<\next{y}\ \DARR\ x\leq y$. We will use this fact freely.}
...
The well-ordering theorem, Theorem \ref{thm:wellord}, provides a new and sometime more powerful way to carry out a proof by induction.
