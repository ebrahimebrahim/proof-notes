...
\newcommand{\THMMOCK}[2]{\thmbox{\textbf{Theorem:} \thmcolonspace #1} \\[0.5em]\textit{Proof:} #2\qed}
\newcommand{\THM}[2]{\thmbox{\textbf{Theorem \putThmNumber:} \thmcolonspace #1} \\[0.5em]\textit{Proof:} #2\qed}
\newcommand{\THMN}[3]{\thmbox{\textbf{Theorem \putThmNumber\ (#1):} \thmcolonspace #2} \\[0.5em]\textit{Proof:} #3\qed}
...
\AXIOMN{Reflexiveness for equality}{$x=x$.}

\AXIOMN{Equality used}{
If $x=y$, then $\SUBST{\pA}{z}{x}\DARR\SUBST{\pA}{z}{y}$.
}

% develop set theory along the lines of jacoby notes

% some milestones to reach: relations, functions, induction, recursion, natural numbers, partial orderings, concepts like sup and inf in ordered sets, cardinality
