...
\newcommand{\DRULE}[2]{\begin{tcolorbox}[title=Derived Rule: #1,colbacktitle=white,coltitle=black,colback=white]#2\end{tcolorbox}} % IDK if derived rules will be different
...
\newcommand{\DRULEPZ}[2]{\begin{tcolorbox}[title=Derived Rule: #1,colbacktitle=white,coltitle=black,colback=white] {#2} \tcblower \textbf{Proof:} 
                         \refstepcounter{exercise} Exercise \thesubsubsection.\theexercise. \end{tcolorbox}}
...
It is a common mistake to think that the converse or the inverse of an implication follow from the implication.
...
\item
If you eat right and sleep well, then you are healthy and you will live long.
\end{enumerate}
}
