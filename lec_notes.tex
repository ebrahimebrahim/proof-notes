...
In the proof of \ref{thm:refl_trans_incl2}, you should be able to spot two uses of \hyperlink{hl:UI}{UI} and one use of \hyperlink{hl:UG}{UG}.
...
%ex idea: pv that if y={b}, then big union (spelled out) of y equals b.
