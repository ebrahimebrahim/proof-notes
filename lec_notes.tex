...
\subsection{Empty Set, Singletons, and More}
...
\DEF{
We call $x$ a \emph{pair} if and only if $x$ has the form $(a,b)$ for some $a$ and $b$.
...
The definition above contains an \emph{assumption}, that $S$ is a set of pairs.
When a definition contains an assumption, the definition is only meant to be used under the conditions of the assumption.
No one will stop you from trying to use the definition outside the conditions of the assumption, but the definition may not behave in the intended way.
