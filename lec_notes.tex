...
NBG has many more axioms like these to make set theoretic constructions such as doubleton, union, power set, etc. work properly
...
Just like with NBG, some bootstrapping is needed in ZF to get set theoretic constructions like doubleton, union, power set, etc. to work properly.
