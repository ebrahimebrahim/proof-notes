...
\indented{
\emph{Take the proposition ``$\pA$'' and replace all occurrences of the variable ``$x$'' with the term ``$T$'', and then write the resulting proposition.}
}
...
\begin{center}\includegraphics[scale=1]{embed.pdf}\end{center}
...
and since the intersection of their domains is empty, it follows from Exercise \ref{ex:piecewise} that $g$ is a function.
...
\IShead{}
Suppose that $m\in\N$ and $\ALL{n}{n\injex m\ARR n\leq m}$.
Consider any $n\injex m+1$.
...
Since $\N\notin\N$ (see Exercise \ref{ex:NnotinN}), we may apply Exercise \ref{ex:piecewise} to
...
$$
With the help of Exercise \ref{ex:piecewise}, it is straightforward to show that $f:2\times\N\rightarrow\N$.
...
For example,
\begin{center}
\includegraphics{relations_gfx/00000.pdf}
\end{center}
depicts the relation $\{(0,1),(1,1),(1,3),(0,2),(2,0)\}$
on the set $\{0,1,2,3\}$.

\newcommand{\exline}[1]{\item \raisebox{-0.8cm}{\includegraphics{relations_gfx/#1.pdf}}}
...
\renewcommand{\exline}[1]{\item \raisebox{-1.3cm}{\includegraphics{relations_gfx/#1.pdf}}}
...
\ex{For each part of Exercise \ref{ex:eqblobs}, determine the equivalence classes $\CLASS{0}{}$ and $\CLASS{1}{}$.
